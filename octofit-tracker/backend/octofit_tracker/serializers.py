...
class OctoFitUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OctoFitUser
        fields = ['id', 'username', 'email', 'password', 'age', 'fitness_level']
...
class TeamSerializer(serializers.ModelSerializer):
    ...
    member_ids = serializers.PrimaryKeyRelatedField(
        many=True, queryset=OctoFitUser.objects.all(), write_only=True, source='members'
    )
...
class ActivitySerializer(serializers.ModelSerializer):
    ...
    user_id = serializers.PrimaryKeyRelatedField(
        queryset=OctoFitUser.objects.all(), write_only=True, source='user'
    )
